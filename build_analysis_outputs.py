...
def clean_later_year_rows(rows, year):
    ...
    exact_heading_titles = {
        ...
        "Trafficking",
        "Continue Commitment to Child Care Access",
        "Create Conditions for Better Outcomes",
        "Support Re-Entry and Reduce Recidivism",
        "Unlock Potential for New Housing",
        "Stand Up for Tenants and Homeowners",
        ...
        "Commit to Indigenous Nations",
        "Commit to All New Yorkers with Disabilities",
        "Support New York Veterans",
        "Strengthen New York's Response to Discrimination and Hate",
        "Strengthen Services for LGBTQ+ New Yorkers",
